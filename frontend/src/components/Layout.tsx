          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm font-body leading-relaxed">
                Your premier destination for discovering the world's finest bikes. From mountain trails to city streets.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/" className="text-muted-foreground hover:text-primary transition-colors text-sm font-body">
                    Browse Catalog
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="text-muted-foreground hover:text-primary transition-colors text-sm font-body">
                    Contact Us
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm font-body">
                Interested in a bike? Submit an inquiry and our team will get back to you within 24 hours.
              </p>
            </div>
          </div>
