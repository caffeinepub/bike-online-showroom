      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-muted-foreground font-body text-lg leading-relaxed mb-10">
            Your inquiry has been successfully submitted. Our team will review
          ...
          <div className="bg-card border border-border rounded-sm p-6 mb-10 text-left">
            ...
            <ul className="space-y-3">
              {[
                {
                  id: "confirm",
                  text: "A confirmation email will be sent to your inbox shortly.",
                },
                {
                  id: "review",
                  text: "Our sales team will review your inquiry and bike preferences.",
                },
                {
                  id: "reach",
                  text: "We'll reach out to schedule a test ride or answer your questions.",
                },
              ].map(({ id, text }, i) => (
                <li key={id} className="flex items-start gap-3">
                  <span className="w-5 h-5 bg-primary/20 rounded-sm flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="font-display font-800 text-primary text-xs">
                      {i + 1}
                    </span>
                  </span>
